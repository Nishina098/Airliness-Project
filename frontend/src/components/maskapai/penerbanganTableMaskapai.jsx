...
const PenerbanganTableMaskapai = () => {
  ...
  const validateForm = (data) => {
    ...
    const kodeRegex = /^[A-Z]{3}-\d{4}$/;
    if (!kodeRegex.test(data.kode_penerbangan)) {
      setError('Kode penerbangan harus dalam format XX-XXXX (contoh: GA-1234)');
      return false;
    }
...
export default PenerbanganTableMaskapai;

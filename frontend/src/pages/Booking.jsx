        ...
        <div className="box has-background-white" style={{ borderRadius: "12px", boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.1)" }}>
          <div className="columns">
            <div className="column">
              ...
              <p style={{ color: '#000' }}><strong>Maskapai:</strong> {penerbangan.maskapai}</p>
              <p style={{ color: '#000' }}><strong>Kode Penerbangan:</strong> {penerbangan.kode_penerbangan}</p>
              <p style={{ color: '#000' }}><strong>Dari:</strong> {penerbangan.dari}</p>
              <p style={{ color: '#000' }}><strong>Ke:</strong> {penerbangan.ke}</p>
              <p style={{ color: '#000' }}><strong>Tanggal Berangkat:</strong> {new Date(penerbangan.tanggal_berangkat).toLocaleDateString('id-ID')}</p>
              <p style={{ color: '#000' }}><strong>Durasi:</strong> {penerbangan.durasi_penerbangan}</p>
              <p style={{ color: '#000' }}><strong>Harga per Tiket:</strong> {formatPrice(penerbangan.harga)}</p>
              <p style={{ color: '#000' }}><strong>Kapasitas:</strong> {penerbangan.kapasitas}</p>
            </div>
